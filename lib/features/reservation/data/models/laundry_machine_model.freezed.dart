...
mixin _$MachineModel {
 ...
 int get machineId; String get name; String get type; String get status; String get availability; String? get operatingState; String? get jobState; String? get switchStatus; String? get expectedCompletionTime; int? get remainingMinutes; int? get reservationId; int? get userId;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,machineId,name,type,status,availability,operatingState,jobState,switchStatus,expectedCompletionTime,remainingMinutes,reservationId,userId);

@override
String toString() {
  return 'MachineModel(machineId: $machineId, name: $name, type: $type, status: $status, availability: $availability, operatingState: $operatingState, jobState: $jobState, switchStatus: $switchStatus, expectedCompletionTime: $expectedCompletionTime, remainingMinutes: $remainingMinutes, reservationId: $reservationId, userId: $userId)';
}
...
@useResult
$Res call({
 int machineId, String name, String type, String status, String availability, String? operatingState, String? jobState, String? switchStatus, String? expectedCompletionTime, int? remainingMinutes, int? reservationId, int? userId
});
...
/// Create a copy of MachineModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? machineId = null,Object? name = null,Object? type = null,Object? status = null,Object? availability = null,Object? operatingState = freezed,Object? jobState = freezed,Object? switchStatus = freezed,Object? expectedCompletionTime = freezed,Object? remainingMinutes = freezed,Object? reservationId = freezed,Object? userId = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int machineId,  String name,  String type,  String status,  String availability,  String? operatingState,  String? jobState,  String? switchStatus,  String? expectedCompletionTime,  int? remainingMinutes,  int? reservationId,  int? userId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MachineModel() when $default != null:
return $default(_that.machineId,_that.name,_that.type,_that.status,_that.availability,_that.operatingState,_that.jobState,_that.switchStatus,_that.expectedCompletionTime,_that.remainingMinutes,_that.reservationId,_that.userId);case _:
  return orElse();
...
class _MachineModel extends MachineModel {
  const _MachineModel({required this.machineId, required this.name, required this.type, required this.status, required this.availability, this.operatingState, this.jobState, this.switchStatus, this.expectedCompletionTime, this.remainingMinutes, this.reservationId, this.userId}): super._();
...
/// Create a copy of MachineModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? machineId = null,Object? name = null,Object? type = null,Object? status = null,Object? availability = null,Object? operatingState = freezed,Object? jobState = freezed,Object? switchStatus = freezed,Object? expectedCompletionTime = freezed,Object? remainingMinutes = freezed,Object? reservationId = freezed,Object? userId = freezed,}) {

...
mixin _$ActiveReservationModel {
 ...
 int get id; int get userId; String? get userStudentId; String get userName; String get userRoomNumber; int get machineId; String get machineName; String? get reservedAt; String? get startTime; String? get expectedCompletionTime; String? get actualCompletionTime; String get status;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,userId,userStudentId,userName,userRoomNumber,machineId,machineName,reservedAt,startTime,expectedCompletionTime,actualCompletionTime,status);
...
@useResult
$Res call({
 int id, int userId, String? userStudentId, String userName, String userRoomNumber, int machineId, String machineName, String? reservedAt, String? startTime, String? expectedCompletionTime, String? actualCompletionTime, String status
});
...
/// Create a copy of ActiveReservationModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? userId = null,Object? userStudentId = freezed,Object? userName = null,Object? userRoomNumber = null,Object? machineId = null,Object? machineName = null,Object? reservedAt = freezed,Object? startTime = freezed,Object? expectedCompletionTime = freezed,Object? actualCompletionTime = freezed,Object? status = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  int userId,  String? userStudentId,  String userName,  String userRoomNumber,  int machineId,  String machineName,  String? reservedAt,  String? startTime,  String? expectedCompletionTime,  String? actualCompletionTime,  String status)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ActiveReservationModel() when $default != null:
return $default(_that.id,_that.userId,_that.userStudentId,_that.userName,_that.userRoomNumber,_that.machineId,_that.machineName,_that.reservedAt,_that.startTime,_that.expectedCompletionTime,_that.actualCompletionTime,_that.status);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  int userId,  String? userStudentId,  String userName,  String userRoomNumber,  int machineId,  String machineName,  String? reservedAt,  String? startTime,  String? expectedCompletionTime,  String? actualCompletionTime,  String status)  $default,) {final _that = this;
switch (_that) {
case _ActiveReservationModel():
return $default(_that.id,_that.userId,_that.userStudentId,_that.userName,_that.userRoomNumber,_that.machineId,_that.machineName,_that.reservedAt,_that.startTime,_that.expectedCompletionTime,_that.actualCompletionTime,_that.status);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  int userId,  String? userStudentId,  String userName,  String userRoomNumber,  int machineId,  String machineName,  String? reservedAt,  String? startTime,  String? expectedCompletionTime,  String? actualCompletionTime,  String status)?  $default,) {final _that = this;
switch (_that) {
case _ActiveReservationModel() when $default != null:
return $default(_that.id,_that.userId,_that.userStudentId,_that.userName,_that.userRoomNumber,_that.machineId,_that.machineName,_that.reservedAt,_that.startTime,_that.expectedCompletionTime,_that.actualCompletionTime,_that.status);case _:
  return null;
...
class _ActiveReservationModel extends ActiveReservationModel {
  const _ActiveReservationModel({required this.id, required this.userId, this.userStudentId, required this.userName, required this.userRoomNumber, required this.machineId, required this.machineName, this.reservedAt, this.startTime, this.expectedCompletionTime, this.actualCompletionTime, required this.status}): super._();
...
/// Create a copy of ActiveReservationModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? userId = null,Object? userStudentId = freezed,Object? userName = null,Object? userRoomNumber = null,Object? machineId = null,Object? machineName = null,Object? reservedAt = freezed,Object? startTime = freezed,Object? expectedCompletionTime = freezed,Object? actualCompletionTime = freezed,Object? status = null,}) {

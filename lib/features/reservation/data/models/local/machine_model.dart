...
abstract class MachineModel with _$MachineModel {
  ...
  // 통세척중(availability=CLEANING). 매주 금요일 오전 10시 자동 통세척 때 붙는다.
  // 운전 중도 예약 가능도 아닌 별도 상태다.
  ...
  // AVAILABLE=미사용, RESERVED=예약, CLEANING=통세척중, 그 외(IN_USE/UNAVAILABLE)=운전중.
  ...
  // 예약 가능 = 고장 아님 + 통세척중 아님 + 예약 안 됨 + 사용 중 아님.
